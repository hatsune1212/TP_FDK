...
def cartesienne(y):
    ...
    return x
print (np.shape(vecteur_y_radar_ligne))
print(vecteur_y_radar_ligne)
# Convert angles from degrees to radians
vecteur_y_radar_ligne[1, :] = np.radians(vecteur_y_radar_ligne[1, :])
# Plot trajectories
...
plt.title('Kalman Filter Radar Tracking')
plt.grid()
plt.show()